  ...
  return (
    <div className="min-h-screen flex bg-ink-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 h-16 border-b border-ink-200 bg-white/85 backdrop-blur supports-[backdrop-filter]:bg-white/70">
          <div className="h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0">
              <button
                onClick={() => setMobileOpen(true)}
                className="lg:hidden inline-flex h-10 w-10 items-center justify-center rounded-lg border border-ink-200 text-ink-700"
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="hidden md:flex items-center h-10 w-72 rounded-xl border border-ink-200 bg-white px-3 text-sm text-ink-500 focus-within:border-brand-500 focus-within:shadow-[0_0_0_4px_rgba(59,130,246,0.15)] transition">
                ...
                />
                <kbd className="hidden lg:inline ml-2 rounded border border-ink-200 bg-ink-50 px-1.5 py-0.5 text-[10px] text-ink-500">
                  ⌘K
                </kbd>
              </div>
              <LanguageSwitcher />
